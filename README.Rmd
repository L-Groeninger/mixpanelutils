...
The goal of mixpanelutils is to provide certain utility functions to work
with Mixpanel and enrich some functionality. It is a package that wraps the
...
This is a basic example which shows you which lookup tables are currently present
in your Project:
...
The function `replace_lookup_table()` helps at as the name suggests replacing a lookup
table with an updated version.
